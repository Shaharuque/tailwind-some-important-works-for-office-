    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-[2fr,1fr] gap-3'>
                <div>
                    <h1>Larger portion</h1>
                    <div className='grid grid-cols-[1fr,2fr]'>
                        <aside className="w-64" aria-label="Sidebar border-solid border-2 border-indigo-600 ">
                        ...
                        <div className='border-solid border-2 border-indigo-600 grid grid-cols-2 ' >
                            <div>
                            <h1  >joy bangla</h1>
                            <h1  >joy bangla</h1>
                            <h1  >joy bangla</h1>
                            ...
                            <div>
                            <h1  className='border-solid border-2 border-indigo-600'>joy bangla</h1>
                            <h1  className='border-solid border-2 border-indigo-600'>joy bangla</h1>
                            <h1  className='border-solid border-2 border-indigo-600'>joy bangla</h1>
                            <h1  className='border-solid border-2 border-indigo-600'>joy bangla</h1>
                            </div>
                ...
                <di className='border-solid border-2 border-pink-600'>
                    <h1>Smaller portion</h1>
                </di>
            </div>
